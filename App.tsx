...
import { AppProduct, CartItem, Page, User, Order, UserRole } from './types';
...
export default function App() {
  ...
  const handleGeneratedIdeas = (ideas: AppProduct[]) => {
    ...
    showToast("New ideas generated successfully!");
  };
  ...
  const toggleSaveApp = (product: AppProduct) => {
    if (!user) {
      showToast("Please login to save ideas");
      navigateTo('login');
      return;
    }
  ...
  const handleBecomeVendor = () => {
    ...
    if (user.role === 'vendor') {
      showToast("You are already a registered vendor.");
      navigateTo('dashboard');
      return;
    }
    ...
    setUser(updatedUser);
    showToast("Application approved! Welcome to the Vendor Program.");
    navigateTo('dashboard');
  };
  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-x-hidden dark:bg-slate-950 transition-colors duration-300">
      ...
      <main className="flex-grow pt-20">
        {currentPage === 'home' && (
          <>
            <Hero onGetStarted={() => navigateTo('generator')} />
            <div className="container mx-auto px-4 py-16">
              <div className="text-center mb-12">
                <h2 className="text-3xl font-bold mb-4 dark:text-white">Featured Blueprints</h2>
                <p className="text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
                  Explore our top-rated, ready-to-deploy application blueprints. 
                  Each comes with a complete architecture plan, UI/UX wireframes, and business strategy.
                </p>
              </div>
              <Marketplace 
        ...
        {currentPage === 'marketplace' && (
          <div className="container mx-auto px-4 py-8">
            <div className="mb-8">
              <h1 className="text-4xl font-bold mb-2 dark:text-white">App Marketplace</h1>
              <p className="text-slate-600 dark:text-slate-400">Discover ready-made app concepts and codebases generated by AI and vetted experts.</p>
            </div>
            <Marketplace 
              products={allApps} 
              onAddToCart={addToCart} 
