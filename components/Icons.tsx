...
export const Key = (props: React.SVGProps<SVGSVGElement>) => (
  <svg 
    ...
    {...props}
  >
    <path d="m21 2-2 2m-7.6 7.6a6 6 0 1 1-5.6-5.6" />
...
export const Copyright = (props: React.SVGProps<SVGSVGElement>) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" 
    {...props}
...
export const Cloud = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path d="M20 16.2V16a6 6 0 0 0-11.83-1.63 4.5 4.5 0 0 0-1.89 8.63" />
    <path d="M12 22h8.5" />
  </svg>
);
...
export const Package = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path d="m3.11 6 9 5.19 9-5.19-9-5.19z" />
    <path d="M12 22.8V11.2" />
  </svg>
);
...
export const Usb = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path d="m18 12 .5-3.5-2-2-2 2 .5 3.5Z" />
  </svg>
);
